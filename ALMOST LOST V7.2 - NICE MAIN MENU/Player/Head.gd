...
func _ready() -> void:
	...
	# IMPORTANT: Make sure the hitbox is in the player_weapon group
	if hitbox:
		hitbox.add_to_group("player_weapon")
		print("Added hitbox to player_weapon group in head.gd _ready")
...
func _on_animation_player_animation_finished(anim_name: StringName) -> void:
	if anim_name == "attack":
		...
		if hitbox:
			...
			print("Disabled hitbox monitoring after attack")
